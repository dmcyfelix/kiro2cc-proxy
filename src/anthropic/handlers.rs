...
async fn handle_non_stream_request(
    ...
    let response_body = json!({
        ...
        "usage": {
            "input_tokens": super::stream::scale_for_client_pub(report_input),
            "output_tokens": reported_output_tokens,
            "cache_creation_input_tokens": super::stream::scale_for_client_pub(report_cache_creation),
            "cache_read_input_tokens": super::stream::scale_for_client_pub(report_cache_read),
            "cache_creation": {
                "ephemeral_5m_input_tokens": super::stream::scale_for_client_pub(report_creation_5m),
                "ephemeral_1h_input_tokens": super::stream::scale_for_client_pub(report_creation_1h)
            }
        }
    });
